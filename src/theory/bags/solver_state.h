...
class SolverState : public TheoryState
{
 public:
  ...
  const std::vector<Node> &  getIntToBagTerms() {return d_intToBagTerms;}
  const std::vector<Node> &  getBagToIntTerms(){return d_iBagToIntTerms;}
 ...
 private:
  ...
  /** bag.to_int terms */
  std::vector<Node> d_intToBagTerms;
  /** bag.to_bag terms */
  std::vector<Node> d_iBagToIntTerms;
