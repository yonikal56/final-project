...
(and (is.prime2 (ffactorsx0 i)) (is.prime2 (ffactorsx1 i)) (is.prime2 (ffactorsx2 i)) (is.prime2 (ffactorsx3 i)) (is.prime2 (ffactorsx4 i)) (is.prime2 (ffactorsx5 i)) (is.prime2 (ffactorsx6 i)) (is.prime2 (ffactorsx7 i))))
))
...
(assert (forall ((i Int))
(=> (and (<= 0 i) (< i numfactors))
(= (ffactorsx0 i) (ffactorsx1 i) (ffactorsx2 i) (ffactorsx3 i) (ffactorsx4 i) (ffactorsx5 i) (ffactorsx6 i) (ffactorsx7 i)))
))
(assert (forall ((y Int))
